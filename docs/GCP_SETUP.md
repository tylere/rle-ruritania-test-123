...
- Access to the GCP project (e.g., `rle-ruritania-test123`)
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-test123" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-test123.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-test123 --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-test123.iam.gserviceaccount.com" \
  --project="rle-ruritania-test123" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-test123.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-test123.
